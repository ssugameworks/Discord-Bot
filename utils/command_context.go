...
// CommandContext는 명령어 처리를 위한 컨텍스트 정보를 담고 있습니다
...
// NewCommandContext는 새로운 CommandContext를 생성합니다
